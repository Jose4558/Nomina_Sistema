...
<head>
    <meta charset="UTF-8">
    <title><?php echo isset($familiarMod) ? 'Modificar Familiar' : 'Crear Familiar'; ?></title>
<link rel="stylesheet" href="../Styles/Styles_Crear_Ausencia.css">
</head>
<body>
<header>
    <h1><?php echo isset($familiarMod) ? 'Modificar Familiar' : 'Crear Nuevo Familiar'; ?></h1>
    <nav>
        <ul>
            <li><a href="V_ListarFamiliares.php">Regresar a Lista</a></li>
        </ul>
    </nav>
</header>
...
<main>
    <section class="form-familiar">
        <form action="<?php echo isset($familiarMod) ? '../Controller/C_ModificarFamiliar.php' : '../Controller/C_CrearFamiliar.php'; ?>" method="POST">
            ...
            <div>
                <button type="submit" class="btn btn-primary">
                    <?php echo isset($familiarMod) ? 'Modificar Familiar' : 'Crear Familiar'; ?>
                </button>
            </div>
        </form>
    </section>
